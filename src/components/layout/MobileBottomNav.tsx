...
export default function MobileBottomNav() {
  ...
  return (
    <nav
      className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#0a0d14]/95 backdrop-blur-lg border-t border-white/10 px-2 py-2 safe-area-bottom shadow-2xl"
            ...
            >
              <Icon
                className={`w-5 h-5 mb-0.5 ${
                  isActive ? "text-indigo-400 scale-110" : "text-gray-400"
